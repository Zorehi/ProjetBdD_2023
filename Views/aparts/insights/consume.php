...
<div class="globalContainer">
    <div class="scrollbar-container" id="scrollbar-aparts-consume">
...
<script text="text/javascript">
    ...
    const scrollbar_aparts_consume = new ScrollBar(document.getElementById('scrollbar-aparts-consume'), { offsetContainer: -16, offsetContent: 0});
    scrollbar_aparts_consume.init();
    
    const apart_consume = document.getElementById('apart_consume');
    apart_consume.dataset.status = 'selected';
    apart_consume.onclick = () => { return false };
    ...
    scrollbar_aparts_consume.refresh();
