<div class="password-box">
    <form action="" method="POST">
        ...
        <div class="password-info">
            <div class="text">Créez un mot de passe d’au moins 6 caractères. Un mot de passe fort est une combinaison de lettres, de chiffres et de signes de ponctuation.</div>
            <div class="inline">
                ...
                <button type="button" class="button" onclick="help()">?</button>
            </div>
        </div>
