...
<div class="globalContainer">
    <div class="scrollbar-container" id="scrollbar-device-consume">
...
<script text="text/javascript">
    ...
    const scrollbar_device_consume = new ScrollBar(document.getElementById('scrollbar-device-consume'), { offsetContainer: -16, offsetContent: 0});
    scrollbar_device_consume.init();
    
    const device_consume = document.getElementById('device_consume');
    device_consume.dataset.status = 'selected';
    device_consume.onclick = () => { return false };
    ...
    Highcharts.chart('basic-column-container', {
        ...
        title: {
            text: 'Consommation de l\'équipement'
        },
        legend: {
            enabled: false
        },
    ...
    scrollbar_device_consume.refresh();
