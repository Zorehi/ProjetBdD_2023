...
-- Mot de passe 'jeje' !
INSERT INTO `users` (`id_users`, `username`, `email`, `password`, `firstname`, `lastname`, `tel`, `birthday`, `id_gender`) VALUES
(2, 'Princess', 'amandinelegrix@hotmail.com', '$argon2i$v=19$m=65536,t=4,p=1$YjNtV3F2aTRyWndhOUp5ZQ$Pjf2aDcV5EPwNeSdqDEBeeg+52jukZih7lUSCGuTO3Y', 'Amandine', 'Legrix', '0610101010', '2002-04-01', 2);
